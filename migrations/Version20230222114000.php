 ...
 */
final class Version20230222114000 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE number (id INT NOT NULL, user_number_id INT DEFAULT NULL, number1 VARCHAR(255) NOT NULL, number2 VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
